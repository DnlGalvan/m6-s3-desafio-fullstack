...
const FormRegisterContact = React.forwardRef(
	({ clientId }: IClientProps, ref) => {
		const { RegisterContact } = useContext(ClientsContext);
		...
		return (
			...
			>
				...
				<input value={clientId} hidden {...register("clientId")} />
				<TextField
